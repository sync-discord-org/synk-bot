...
const STORE_PATH = path.join(__dirname, "../../database/rankingMessages.json");
...
function loadTrackedMessages() {
    try {
        ...
        console.error("[RankingMessageStore] Erro ao carregar mensagens rastreadas:", e);
        return {};
    }
}
...
function saveTrackedMessages(dados) {
    try {
        ...
        console.error("[RankingMessageStore] Erro ao salvar mensagens rastreadas:", e);
    }
}
